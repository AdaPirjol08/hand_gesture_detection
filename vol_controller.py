...
# Cross-platform volume control function
def set_volume(vol):
    ...
    if system == "Darwin":  # macOS
        ...
        print(f"Set volume to {vol}% (Implement Windows volume control if needed)")
    else:
...
def vol_control(control='continuous', vol_step=10, traj_size=10):
    ...
    set_volume(vol)  # Use cross-platform function
            ...
            if hands:
                ...
                if control == 'continuous':
                    ...
                    if finger_states[4] > 2:
                        ...
                        set_volume(int(vol))  # Convert float to int before setting volume
