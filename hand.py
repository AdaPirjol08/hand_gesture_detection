...
class HandDetector:
    def __init__(self, static_image_mode=False, max_num_hands=2,
        ...
        #                                  int(self.min_tracking_confidence))
        
        self.hands = self.mp_hands.Hands(
                                        static_image_mode=self.static_image_mode,
                                        max_num_hands=self.max_num_hands,
                                        min_detection_confidence=float(self.min_detection_confidence),  # Ensure float
                                        min_tracking_confidence=float(self.min_tracking_confidence)  # Ensure float
                                        )
