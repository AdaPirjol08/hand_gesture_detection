...
def draw_transparent_box(img, pt1, pt2, alpha=0.5, beta=0.5):
    ...
    # Ensure pt1 and pt2 have valid values
    if None in pt1 or None in pt2:
        print(f"Error: Invalid bounding box points -> pt1={pt1}, pt2={pt2}")
        return
    ...
    # Check if bounding box area is valid
    if pt1[0] >= pt2[0] or pt1[1] >= pt2[1]:
        print(f"Warning: Invalid bounding box dimensions -> pt1={pt1}, pt2={pt2}")
        return
    ...
    img[pt1[1]:pt2[1], pt1[0]:pt2[0]] = res  # Apply the transparent overlay
